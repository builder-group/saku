...
export const Block: React.FC<TBlockProps> = ({ blockState, editor }) => {
	...
	return (
		<div
			...
			className={cn(
				...
				isSelected &&
					'before:absolute before:top-0 before:left-0 before:h-full before:w-1 before:-translate-x-2 before:rounded-full before:bg-[#2C6ECB]',
				// Hover indicator styles
				!isSelected &&
					'before:absolute before:top-0 before:left-0 before:h-full before:w-1 before:-translate-x-2 before:rounded-full before:bg-neutral-200 before:opacity-0 before:transition-opacity hover:before:opacity-100',
				'cursor-pointer'
			)}
