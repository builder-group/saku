...
- **Mantle:** We use Mantle to manage our Shopify app business operations including billing, subscriptions, and revenue tracking. [Privacy Policy of Mantle](https://heymantle.com/privacy).
- **PostHog:** We use PostHog for product analytics, A/B testing, and feature management to improve our service. [Privacy Policy of PostHog](https://posthog.com/privacy).
- **Grafana:** We use Grafana for system monitoring, logging, and performance metrics to ensure our services run smoothly. [Privacy Policy of Grafana](https://grafana.com/legal/privacy-policy/).
- **Crisp:** We use Crisp to provide customer support via a chat widget on our website. [Privacy Policy of Crisp](https://crisp.chat/en/privacy/).

| Service | Purpose                            | Data Collected                                           |
| ------- | ---------------------------------- | -------------------------------------------------------- |
| Shopify | Core platform integration          | Store information, merchant data                         |
| Fly.io  | Application hosting                | Server logs, performance metrics                         |
| Neon    | Database storage                   | Application data                                         |
| Resend  | Email delivery                     | Email addresses, email content                           |
| Mantle  | Business and billing management    | Billing data, subscription status, merchant information  |
| PostHog | Product analytics and testing      | Usage patterns, feature interactions                     |
| Grafana | System monitoring and logging      | Server logs, performance metrics, error logs             |
| Crisp   | Customer support chat              | Chat messages, user agent, IP address, session data      |
...
- Mantle receives subscription and billing data to manage our Shopify app business operations
- PostHog collects anonymized usage data to help us understand how our services are used and identify areas for improvement
- Crisp collects chat conversation data to provide you with customer support when you use our chat widget
- Grafana collects system-level logs and metrics to monitor application health and performance, which helps us maintain reliable service
...
You can control the use of cookies at the individual browser level. If you choose to disable cookies, it may limit your use of certain features or functions on our website or service. We do not use, or allow the use of, cookies or similar technologies in connection with your customers' data.
