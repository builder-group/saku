...
export const MappedTextField = <GValue, GStateValue, GParentStateValue>(
	props: TMappedTextFieldProps<GValue, GStateValue, GParentStateValue>
) => {
	const {
		label,
		state,
	...
	const parentValue = useCompute(parentState, ({ value: parent }) =>
		parent != null && mapParentValue ? mapParentValue(parent) : undefined
	);
	...
	const handleChange = React.useCallback(
		(newValue: string) => {
			...
			let convertedValue: GValue | undefined = newValue === '' ? undefined : (newValue as GValue);
	...
	return (
		<div className={cn('space-y-1', className)}>
			<div className="flex items-center justify-between">
				...
				{parentValue != null && onInheritChange && (
					<button
						type="button"
...
export interface TMappedTextFieldProps<GValue, GStateValue, GParentStateValue>
