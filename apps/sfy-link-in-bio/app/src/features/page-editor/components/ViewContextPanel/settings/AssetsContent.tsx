...
import { AssetsContentPlaceholder } from './AssetsContentPlaceholder';

export const AssetsContent: React.FC<TAssetsContentProps> = (props) => {
	const { editor } = props;
	...
	return (
		<div className="flex h-full flex-col">
			...
			<div className="flex-1 overflow-auto">
				{!hasAssets && <AssetsContentPlaceholder />}
