...
export type TAutoLayoutStyleMixin = TBaseMixin<
	...
	TRef<
		{
			paddingTop?: TRef<number | undefined>;
			paddingRight?: TRef<number | undefined>;
			paddingBottom?: TRef<number | undefined>;
			paddingLeft?: TRef<number | undefined>;
			marginTop?: TRef<number | undefined>;
			marginRight?: TRef<number | undefined>;
			marginBottom?: TRef<number | undefined>;
			marginLeft?: TRef<number | undefined>;
...
>;
export type TTextTitleStyleMixin = TBaseMixin<'textTitle', TTextStyleMixin['value']>;
export type TTextBodyStyleMixin = TBaseMixin<'textBody', TTextStyleMixin['value']>;
export type TTextCaptionStyleMixin = TBaseMixin<'textCaption', TTextStyleMixin['value']>;
...
export type TProductDetailsStyleMixin = TBaseMixin<
	...
	TRef<{
		...
		stroke: TStrokeStyleMixin['value'];
		shadow: TShadowStyleMixin['value'];
		textTitle: TTextTitleStyleMixin['value'];
